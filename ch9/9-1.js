...
function distanceTravelled(scenario, time) {
	...
	if (secondaryTime > 0) {
		...
		const secondAccelation = (scenario.primaryForce + scenario.secondaryForce) / scenario.mass;
		result += primaryVelocity * secondaryTime + 0.5 * secondAccelation * secondaryTime * secondaryTime;
	}
	return result;
}
